...
if resp == 404: #check if site not work
    ...
    with open("C:\\Users\\Mark\\Documents\\GitHub\\SP\\Rasp.txt", "w") as file: #write in file
        for item in Lesson: #write all text from html tag in txt file
            file.write(item.text +"\n")
    
    lines = open("C:\\Users\\Mark\\Documents\\GitHub\\SP\\Rasp.txt").readlines() #list all line in txt file 
    for i in range(104): #Delete first 104 line, because they unused
        lines.pop(0)

    with open("C:\\Users\\Mark\\Documents\\GitHub\\SP\\Rasp.txt", "w") as f: #after delete unused elements, write new line in txt file
